...
class AgilentU2000:
    ...
    def post_creation_data(self, i_settings, stuffing, start_tse,
        ...
        if test_plan == 'True':
            raw_data_url = (BASE_INSTANCE + "/u2000data/"
                           + COMPANYNAME + '/' + HARDWARENAME +'/'
                           + config_name
                           + "/%s" % start_tse)
            url_t = (BASE_INSTANCE +  "/u2000_testresults/"
            ...
            url_t = (BASE_INSTANCE "/u2000_traceresults/"
    ...
    def post_complete(self, active_testplan_name, config_name,
        ...
        headers = {'Content-type': 'application/json', 'Accept': 'text/plain'}
        url_c = (BASE_INSTANCE + "/u2000_testcomplete/"
                + COMPANYNAME + '/' + active_testplan_name
    ...
    def transmitblob(self):
        ...
        blob_url = requests.get(BASE_INSTANCE + "/upload/geturl")
