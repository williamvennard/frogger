...
class agilentu2000:
    ...
    def post_creation_data(self, pass_fail, pass_fail_type, max_value, min_value, correction_frequency, stuffing, start_tse, parent, config_name, active_testplan_name, test_plan) :
        s = self.s
        ...
        if test_plan == True:
            ...
            window_u2000 = {'pass_fail':pass_fail, 'pass_fail_type':pass_fail_type, 'max_value':max_value, 'min_value':min_value, 'correction_frequency':correction_frequency, 'cha':stuffing, 'raw_data_url':raw_data_url, 'start_tse':start_tse, 'test_plan':test_plan, 'config_name':config_name, 'testplan_name':active_testplan_name, 'hardware_name':HARDWARENAME}
    ...
    def post_complete(self, active_testplan_name, config_name, test_plan, stop_tse, pass_fail, pass_fail_type, max_value, min_value, correction_frequency, start_tse, test_results):
        s = self.s
        window_complete = {'active_testplan_name':active_testplan_name, 'cha':test_results, 'config_name':config_name,'test_plan':test_plan, 'stop_tse':stop_tse, 'pass_fail':pass_fail, 'pass_fail_type':pass_fail_type, 'max_value':max_value, 'min_value':min_value, 'correction_frequency':correction_frequency, 'start_tse':start_tse, 'hardware_name':HARDWARENAME}
    ...
    def transmitraw(self):
        ...
        pass_fail = self.u2000_test_results['pass_fail']
        pass_fail_type = self.u2000_test_results['pass_fail_type']
        max_value = self.u2000_test_results['max_value']
        min_value = self.u2000_test_results['min_value']
        correction_frequency = self.u2000_test_results['correction_frequency']
        ...
        self.post_creation_data(pass_fail, pass_fail_type, max_value, min_value, correction_frequency, test_results, start_tse, parent, config_name, active_testplan_name, test_plan)
    ...
    def testcomplete(self):
        ...
        start_tse = int(self.u2000_test_results['Start_TSE'])
        test_results = self.u2000_test_results['data']
        self.post_complete(active_testplan_name, config_name, test_plan, stop_tse, pass_fail, pass_fail_type, max_value, min_value, correction_frequency, start_tse, test_results)
